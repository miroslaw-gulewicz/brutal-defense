...
[CreateAssetMenu(fileName = "EffectAgentsLevelsCollection",
	menuName = "ScriptableObjects/EffectAgentsLevelsCollection")]
public class EffectAgentsLevelsCollection : ScriptableObject, ISerializationCallbackReceiver
{
	[SerializeField] TypesAgentLevels[] typesAgentLevels;

	Dictionary<IAffected.EffectType, Dictionary<int, EffectInflictorAgent>> dictionary;

	public void OnAfterDeserialize()
	{
		dictionary = typesAgentLevels.ToDictionary(keySelector: e => e.effectType,
			elementSelector: e => e.agentLevels.ToDictionary(i => i.level, i => i.agent));
	}
	...
	public class TypesAgentLevels
	{
		...
		[SerializeField] internal AgentLevels[] agentLevels;
	}
