...
{
	[Header("Weapon")] [SerializeField] protected float _range;

	[SerializeField] protected float fireSpeed;

	[SerializeField] protected Projectile projectile;

	[SerializeField] protected BaseEffectInflictor[] inflictors;

	[SerializeField] private SpriteLibraryAsset _weaponSpriteLibrary;
