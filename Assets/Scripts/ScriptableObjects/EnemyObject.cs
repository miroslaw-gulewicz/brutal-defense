...
public class EnemyObject : ScriptableObject
{
	...
	[SerializeField] private Effects defaultEffects;

	[SerializeField] private ResistanceHolder resistance;

	[SerializeField] private BasicStatsHolder basicStats;

	[SerializeField] private BaseEffectInflictor[] effectInflicors;
	...
	public EffectInflictor[] SelfInflictors
	{
		get => effectInflicors;
	}
