...
{
	[SerializeField] protected HighlightTrigger _highlightTrigger;

	[SerializeField] protected SelectableBehaviour _selectableBehaviour;

	[SerializeField] private ProximityTriggerBehaviour _proximityTriggerBehaviour;

	private TurretBehaviour placedTurret;

	public TurretBehaviour PlacedTurret
	{
		get => placedTurret;
		set => placedTurret = value;
	}
