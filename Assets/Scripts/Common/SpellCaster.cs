...
public class SpellCaster : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject spellsRoot;

    [SerializeField]
    private ObjectPlacementControl placementControl;
    ...
    public Spell ActiveSpell { get => _activeSpell; }
    ...
    public void SetupSpell(Spell spell)
    {
        ...
        placementControl.Setup(_activeSpell.GizmoPrefab, OnAquireTarget, _activeSpell.TargetsAgentLayer, spell.TargetsAgentLayer != _worldLayerMask);
    }
