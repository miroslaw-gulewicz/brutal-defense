...
public class Agent : MonoBehaviour, IDestructable, IAffected, IHighlightable, ISelectable
{
	...
	[SerializeField] protected HighlightTrigger highlightTrigger;

	[SerializeField] protected SelectableBehaviour selectableBehaviour;

	[SerializeField] protected DamageVisualizer _damageVisualizer;

	[SerializeField] protected IndicatorBarBehaviour _hpBar;
...
/*        if (gameObject.activeSelf)
	...
	public BasicStatsManager stats => _statsManager;
}