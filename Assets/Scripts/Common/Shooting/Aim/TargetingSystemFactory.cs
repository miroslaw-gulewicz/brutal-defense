namespace Aim
{
	public static class TargetingSystemFactory
	{
		public static TargetingSystem Supply(TargetingSystemType targetingSystemType)
		{
			...
			switch (targetingSystemType)
			{
				...
				case TargetingSystemType.MANUAL:
					targetingSystem = new ManualTargetingSystem();
					break;
		...
		public static TargetingSystemType AsTargetingSystemType(TargetingSystem targetingSystem) =>
			(TargetingSystemType)targetingSystem.TargetingSystemID;
	}
