...
{
	[SerializeField] TurretObjectDef towerObjectDef;
	...
	[SerializeField] private TMPro.TextMeshProUGUI _cost;

	[SerializeField] private SelectableBehaviour selectableBehaviour;

	public Action<BuildTowerButton> Action
	{
		get => action;
		set => action = value;
	}

	public TurretObjectDef TowerObjectDef
	{
		get => towerObjectDef;
		set
		{
			towerObjectDef = value;
			Init();
		}
	}
