...
public class SpellBookUI : MonoBehaviour, ITab
{
	...
	[SerializeField] private bool _autoCast = true;

	[SerializeField] private Canvas spelbookCanvas;

	[SerializeField] public Button CancelSpellBookButton;

	[SerializeField] public Button CancelSpellButton;

	[SerializeField] private Button applySpell;
	...
	private void Awake()
	{
		...
		CancelSpellBookButton.onClick.AddListener(() => OnCloseTab?.Invoke());
	}
